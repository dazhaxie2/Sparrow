...
# ───────────────────── 产业链专题库(与图谱语义隔离) ─────────────────────
SPARROW_CHAIN_DB_HOST = os.getenv("SPARROW_CHAIN_DB_HOST", _LEGACY_SPARROW_DB_HOST)
SPARROW_CHAIN_DB_PORT = int(os.getenv("SPARROW_CHAIN_DB_PORT", _LEGACY_SPARROW_DB_PORT))
SPARROW_CHAIN_DB_USER = os.getenv("SPARROW_CHAIN_DB_USER", _LEGACY_SPARROW_DB_USER)
SPARROW_CHAIN_DB_PASSWORD = os.getenv("SPARROW_CHAIN_DB_PASSWORD", _LEGACY_SPARROW_DB_PASSWORD)
SPARROW_CHAIN_DB_NAME = os.getenv("SPARROW_CHAIN_DB_NAME", "sparrow_chain")
