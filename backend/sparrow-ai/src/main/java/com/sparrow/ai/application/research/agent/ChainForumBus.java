 ...
 */
@Component
public class ChainForumBus {

    private static final Logger log = LoggerFactory.getLogger(ChainForumBus.class);
    ...
    public ChainForumBus(ChainResearchRepository repository, ChainResearchEventHub events,
