...
import com.sparrow.ai.application.research.ir.Block.SwotItem;
 ...
 */
@Component
public class ChainReportBuilder {

    private static final Logger log = LoggerFactory.getLogger(ChainReportBuilder.class);
    ...
    public ChainReportBuilder(ChatModelProvider chat, ObjectMapper objectMapper, IrValidator validator) {
        this.chat = chat;
